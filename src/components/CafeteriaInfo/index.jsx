...
import { CheckmarkStarburst24Filled, Star28Filled } from '@fluentui/react-icons';


function CafeteriaInfo() {
            ...
            <div className='flex'>
                ...
                <div className='ml-5 flex flex-col justify-center'>
                    <div className='flex gap-4'>
                        <h1 className='font-bold text-xl text-slate-700'>The Cafeteria Gonçalves</h1>
